 ...
 * Returns `fallback` if the file doesn't exist, is empty, or has invalid JSON.
 * Also auto-repairs the file by writing the fallback value when corrupt.
 */
function safeReadJSON(filePath, fallback = {}) {
    try {
        ...
        console.error(`[safeReadJSON] Corrupt file at ${filePath}, resetting. Error:`, err.message);
...
async function addGoodbye(jid, enabled, message) {
    try {
        ...
        data.goodbye[jid] = {
            ...
            channelId: '120363417440480101@newsletter'
        };
