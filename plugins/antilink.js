...
// V2 Plugin Wrapper
const _wrapped_antilink = module.exports;
module.exports = {
  name: 'antilink',
  aliases: [],
  category: 'admin',
  ...
  async execute(sock, msg, args, extra) {
    ...
    const fn = Object.values(_wrapped_antilink).find(v => typeof v === 'function');
    if (fn) await fn(sock, chatId, message, q, isOwnerOrSudo, isGroup);
    else throw new Error('No execute function found in antilink.js');
  },
};
