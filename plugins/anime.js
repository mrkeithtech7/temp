...
// V2 Plugin Wrapper
const _wrapped_animu = module.exports;
module.exports = {
  name: 'animu',
  aliases: ['nom', 'poke', 'cry', 'kiss', 'pat', 'hug', 'wink', 'facepalm'],
  category: 'anime',
  ...
  async execute(sock, msg, args, extra) {
    ...
    const fn = Object.values(_wrapped_animu).find(v => typeof v === 'function');
    if (fn) await fn(sock, chatId, message, q, isOwnerOrSudo, isGroup);
    else throw new Error('No execute function found in anime.js');
  },
};
